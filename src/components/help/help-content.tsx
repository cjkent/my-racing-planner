    ...
    <>
      ...
      <section>
        ...
        <List.Root>
          ...
          <List.Item>
            <strong>
              Give your feedback <FontAwesomeIcon size="xs" icon={faMessage} />
            </strong>
            : Send me an{" "}
            <Tooltip
              lazyMount
      ...
      <section>
        ...
        <Text mb={2} as="p">
          This site can be installed as a Progressive Web App (PWA) for a more
          app-like experience. Follow the steps below to add it to your home
          screen:
        </Text>
        ...
        <List.Root as="ol">
          <List.Item>Open this site in Safari on an iPhone or iPad.</List.Item>
          <List.Item>
          ...
          <List.Item>Confirm by tapping Add in the top-right corner.</List.Item>
        </List.Root>
        ...
        <List.Root as="ol">
          <List.Item>Open this site in Chrome on an Android device.</List.Item>
          <List.Item>
            Tap the Menu button (three dots in the top-right corner)).
          </List.Item>
          <List.Item>Select Add to Home Screen.</List.Item>
          <List.Item>
            Confirm by tapping Add and choose whether to add it automatically or
            manually.
          </List.Item>
        </List.Root>
        <Text my={2} as="p">
          After adding, the PWA will appear on the home screen and behave like a
          native app, offering a seamless experience.
        </Text>
      </section>
    </>
  );
